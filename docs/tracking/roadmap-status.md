...
| Wave 9 (soak) | Soak period | 0.21.0–0.25.13+ | **reset-needed** | — | 0.25.13 | Started 2026-04-18, but feature-bearing 0.23.x, 0.24.0, and 0.25.x releases landed after that. Owner sign-off pending and soak criteria need a fresh definition before 1.0.0. |
