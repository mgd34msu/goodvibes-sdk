...
// @public (undocumented)
export const DISTRIBUTED_WORK_TYPES: readonly ["invoke", "status.request", "location.request", "session.message", "automation.run", "device.capability"];
...
export const FOUNDATION_METADATA: {
    ...
    readonly productVersion: "1.21.0";
    readonly operatorMethodCount: 502;
...
export interface OperatorMethodInputMap {
    ...
    "occasions.confirm": {
        title: string;
        date: string;
        kind: "gift-giving" | "neither" | "remember-only";
        person?: string;
    ...
    "payments.cards.create": {
        ...
        issuerCapMinorUnits?: null | number;
    };
    // (undocumented)
    ...
    "payments.checkout.begin": {
        ...
        cardFields: readonly ({
            field: "cardholderName" | "cvv" | "expiry" | "expiryMonth" | "expiryYear" | "number";
            ref: string;
        })[];
        addressFields?: readonly ({
            kind: "billing" | "shipping";
            field: "city" | "country" | "line1" | "line2" | "name" | "postalCode" | "region";
            ref: string;
        })[];
        shippingTargets?: readonly string[];
        placeOrderTarget: string;
        preferredTier?: "fast" | "fastest" | "normal";
...
export interface OperatorMethodOutputMap {
    ...
    "models.current.get": {
        ...
        configured: boolean;
        configuredVia?: "anonymous" | "env" | "secrets" | "subscription";
        routes?: readonly ({
            route: "anonymous" | "api-key" | "none" | "secret-ref" | "service-oauth" | "subscription-oauth";
            label: string;
            configured: boolean;
            usable?: boolean;
            freshness?: "expired" | "expiring" | "healthy" | "pending" | "unconfigured";
    ...
    "models.list": {
        ...
        secretsResolutionSkipped: boolean;
    };
    // (undocumented)
    "multimodal.analyze": {
        analysis: {
    ...
    "occasions.list": {
        ...
        occasions: readonly ({
            ...
            daysUntil: null | number;
            leadDays: number;
            inLeadWindow: boolean;
            answer: null | "later" | "no" | "yes";
            mirrored: boolean;
        })[];
        unparsed: readonly ({
            lineIndex: number;
    ...
    "occasions.pending": {
        ...
        nudge: null | {
            ...
            subjects: readonly ({
                ...
                person: string;
                kind: "gift-giving" | "neither" | "remember-only";
                proximity: "approaching" | "imminent" | "soon";
            })[];
            message: string;
            answerable: boolean;
        };
    ...
    "occasions.sweep": {
        ...
        conflictMessages: readonly string[];
        resumedInterviews: readonly string[];
        delivered: boolean;
        deliveryChannel: string;
    ...
    "payments.checkout.begin": {
        ...
        reason: null | string;
        merchantOrderId: null | string;
        totalMinorUnits: null | number;
        currency: null | string;
        shippingTierUsed: null | string;
        steppedDown: boolean;
        challengeStep: null | string;
    };
    // (undocumented)
    "payments.checkout.fillCard": {
        ok: boolean;
        filled: readonly string[];
        failedField: null | string;
        reason: null | string;
    };
    // (undocumented)
    "payments.purchases.list": {
    ...
    "sessions.hosted.attach": {
        session: {
            ...
            detachPolicy: null | "kill" | "survive";
            effectiveDetachPolicy: "kill" | "survive";
            attachedClients: readonly string[];
            providerId?: string;
            modelId?: string;
            createdAt: number;
            updatedAt: number;
...
// @public
export const ROUTE_SURFACE_KINDS: readonly ["tui", "web", "slack", "discord", "ntfy", "webhook", "homeassistant", "telegram", "google-chat", "signal", "whatsapp", "telephony", "imessage", "msteams", "bluebubbles", "mattermost", "matrix", "service"];
...
// @public
export type SDKErrorCode = 'AUTH_REQUIRED' | 'TOKEN_EXPIRED' | 'PERMISSION_DENIED' | 'PAYMENT_REQUIRED' | 'RATE_LIMITED' | 'NETWORK_UNREACHABLE' | 'TIMEOUT' | 'CANCELLED' | 'NOT_FOUND' | 'CONFLICT' | 'SESSION_CLOSED' | 'NOT_INVOKABLE' | 'METHOD_NOT_FOUND' | 'VALIDATION_FAILED' | 'AGENT_TIMEOUT' | 'AGENT_FAILED' | 'TOOL_EXEC_FAILED' | 'SERVICE_UNAVAILABLE' | 'CONTRACT_MISMATCH' | 'PROTOCOL_ERROR' | 'INTERNAL_ERROR' | 'SDK_CONFIGURATION_ERROR' | 'SDK_CONTRACT_ERROR' | 'SDK_HTTP_STATUS_ERROR' | 'UNKNOWN';
...
export const SDKErrorCodes: {
    ...
    readonly NOT_INVOKABLE: "NOT_INVOKABLE";
