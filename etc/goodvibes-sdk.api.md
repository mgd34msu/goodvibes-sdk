...
export const FOUNDATION_METADATA: {
    ...
    readonly operatorMethodCount: 409;
...
export interface OperatorMethodOutputMap {
    ...
    "fleet.archived.list": {
        ...
        nodes: readonly (({
            id: string;
            kind: "acp-agent" | "agent" | "background-process" | "code-index" | "phase" | "schedule" | "trigger" | "watcher" | "work-item" | "workflow" | "workstream" | "wrfc-chain" | "wrfc-subtask";
            parentId?: string;
            label: string;
            task?: string;
