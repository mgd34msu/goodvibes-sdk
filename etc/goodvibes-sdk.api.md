...
export const FOUNDATION_METADATA: {
    ...
    readonly productVersion: "2.0.13";
...
export interface OperatorMethodInputMap {
    ...
    "occasions.acknowledge": {
        occasionId: string;
        source?: "conversation" | "explicit" | "gift-flow";
        occurrence?: string;
    };
    // (undocumented)
    "occasions.answer": {
        occasionId: string;
        answer: "acknowledged" | "later" | "no" | "yes";
        occurrence?: string;
    };
    // (undocumented)
    "occasions.confirm": {
    ...
    "occasions.list": {
        ...
        occasions: readonly ({
            occasion: {
                ...
                subject: "other" | "owner" | "unattributed";
            ...
            answer: null | "acknowledged" | "later" | "no" | "yes";
            mirrored: boolean;
        })[];
        unparsed: readonly ({
            lineIndex: number;
