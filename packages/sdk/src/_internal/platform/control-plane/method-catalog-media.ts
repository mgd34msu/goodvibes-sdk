...
export const builtinGatewayMediaMethodDescriptors: readonly GatewayMethodDescriptor[] = [
  ...
  methodDescriptor({
    ...
    inputSchema: VOICE_TRANSCRIPTION_REQUEST_SCHEMA,
  ...
  methodDescriptor({
    ...
    inputSchema: VOICE_REALTIME_SESSION_REQUEST_SCHEMA,
  ...
  methodDescriptor({
    ...
    inputSchema: MEDIA_ANALYZE_REQUEST_SCHEMA,
  ...
  methodDescriptor({
    ...
    inputSchema: MEDIA_TRANSFORM_REQUEST_SCHEMA,
  ...
  methodDescriptor({
    ...
    inputSchema: MEDIA_GENERATION_REQUEST_SCHEMA,
  ...
  methodDescriptor({
    ...
    inputSchema: MULTIMODAL_ANALYZE_REQUEST_SCHEMA,
  ...
  methodDescriptor({
    ...
    inputSchema: MULTIMODAL_PACKET_REQUEST_SCHEMA,
  ...
  methodDescriptor({
    ...
    inputSchema: MULTIMODAL_WRITEBACK_REQUEST_SCHEMA,
