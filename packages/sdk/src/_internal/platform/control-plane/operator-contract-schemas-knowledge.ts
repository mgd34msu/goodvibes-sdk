...
export const KNOWLEDGE_REFINEMENT_TASK_STATE_SCHEMA = enumSchema([
  'detected',
  'queued',
  'searching',
  'evaluating',
...
export const KNOWLEDGE_REFINEMENT_TASK_TRIGGER_SCHEMA = enumSchema([
  'ingest',
  'homegraph-sync',
  'reindex',
  'scheduled',
...
export const KNOWLEDGE_REFINEMENT_TASK_PRIORITY_SCHEMA = enumSchema(['low', 'normal', 'high', 'urgent']);
...
const KNOWLEDGE_JOB_RUN_SELF_IMPROVEMENT_RESULT_SCHEMA = objectSchema({
  ...
  errors: GENERIC_LIST_SCHEMA,
}, ['scannedGaps', 'createdGaps', 'repairableGaps', 'suppressedGaps', 'skippedGaps', 'searched', 'ingestedSources', 'linkedRepairs', 'errors'], { additionalProperties: true });
...
export const KNOWLEDGE_NODE_SCHEMA = objectSchema({
  ...
  subjectIds: STRING_LIST_SCHEMA,
  targetHints: arraySchema(JSON_RECORD_SCHEMA),
  linkedObjectIds: STRING_LIST_SCHEMA,
  metadata: METADATA_SCHEMA,
  createdAt: NUMBER_SCHEMA,
  updatedAt: NUMBER_SCHEMA,
...
export const KNOWLEDGE_STATUS_SCHEMA = objectSchema({
  ...
  refinementTaskCount: NUMBER_SCHEMA,
  usageCount: NUMBER_SCHEMA,
  candidateCount: NUMBER_SCHEMA,
  reportCount: NUMBER_SCHEMA,
  scheduleCount: NUMBER_SCHEMA,
}, ['ready', 'storagePath', 'sourceCount', 'nodeCount', 'edgeCount', 'issueCount', 'extractionCount', 'jobRunCount', 'usageCount', 'candidateCount', 'reportCount', 'scheduleCount'], { additionalProperties: true });

export const KNOWLEDGE_REFINEMENT_TASK_SCHEMA = objectSchema({
  id: STRING_SCHEMA,
  spaceId: STRING_SCHEMA,
  subjectKind: STRING_SCHEMA,
  subjectId: STRING_SCHEMA,
  subjectTitle: STRING_SCHEMA,
  subjectType: STRING_SCHEMA,
  gapId: STRING_SCHEMA,
  issueId: STRING_SCHEMA,
  state: KNOWLEDGE_REFINEMENT_TASK_STATE_SCHEMA,
  priority: KNOWLEDGE_REFINEMENT_TASK_PRIORITY_SCHEMA,
  trigger: KNOWLEDGE_REFINEMENT_TASK_TRIGGER_SCHEMA,
  budget: recordSchema(NUMBER_SCHEMA),
  attemptCount: NUMBER_SCHEMA,
  blockedReason: STRING_SCHEMA,
  nextRepairAttemptAt: NUMBER_SCHEMA,
  acceptedSourceIds: arraySchema(STRING_SCHEMA),
  ingestedSourceIds: arraySchema(STRING_SCHEMA),
  rejectedSourceUrls: arraySchema(STRING_SCHEMA),
  promotedFactCount: NUMBER_SCHEMA,
  sourceAssessments: GENERIC_LIST_SCHEMA,
  trace: GENERIC_LIST_SCHEMA,
  metadata: METADATA_SCHEMA,
  createdAt: NUMBER_SCHEMA,
  updatedAt: NUMBER_SCHEMA,
}, ['id', 'spaceId', 'state', 'priority', 'trigger', 'budget', 'attemptCount', 'trace', 'metadata', 'createdAt', 'updatedAt'], { additionalProperties: true });

export const KNOWLEDGE_REFINEMENT_TASKS_OUTPUT_SCHEMA = objectSchema({
  tasks: arraySchema(KNOWLEDGE_REFINEMENT_TASK_SCHEMA),
}, ['tasks'], { additionalProperties: true });

export const KNOWLEDGE_REFINEMENT_TASK_OUTPUT_SCHEMA = objectSchema({
  task: KNOWLEDGE_REFINEMENT_TASK_SCHEMA,
