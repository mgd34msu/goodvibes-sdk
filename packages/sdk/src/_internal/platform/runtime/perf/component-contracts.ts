...
// ---------------------------------------------------------------------------
// Backward-compatible aliases — existing SDK code that imports Panel* names
...
export type PanelResourceContract = Omit<ComponentResourceContract, 'componentId'> & { panelId: string };

/** @deprecated Use ComponentHealthState */
export type PanelHealthState = Omit<ComponentHealthState, 'componentId'> & { panelId: string };
