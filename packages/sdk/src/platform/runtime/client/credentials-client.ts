 ...
 * VALUE that reference points at. When a surface hosted the daemon, both halves
 * landed in one process's tree and the pair held.
 *
 ...
 * caller (a settings modal, a payments command, an onboarding wizard) renders
