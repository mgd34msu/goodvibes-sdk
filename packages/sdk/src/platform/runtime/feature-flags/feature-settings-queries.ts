...
import { CONFIG_SCHEMA, type ConfigKey, type ConfigManager, type ConfigSetting } from '../../config/index.js';
import {
  FEATURE_SETTINGS,
  deriveFeatureState,
  type FeatureSetting,
...
export type { FeatureSetting } from '../state.js';
...
/** The CONFIG_SCHEMA descriptor for a settings key, or null for host-local synthetics. */
