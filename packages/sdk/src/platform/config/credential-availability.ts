 ...
 * Only 'external' (a separately-running daemon this surface adopted) reads
 * credential STATUS over the wire; every other mode ('embedded'/'disabled'/
 * 'blocked'/'incompatible'/'unavailable') is the local host reading its own store.
 */
 ...
 * the wire contract exactly: any failure becomes a
