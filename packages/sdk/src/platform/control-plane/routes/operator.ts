import type { DaemonApiRouteHandlers, MaybeResponse } from './context.js';
import { readBoundedPositiveInteger } from '@pellux/goodvibes-daemon-sdk';

type OperatorRouteHandlers = Omit<DaemonApiRouteHandlers, 'getStatus' | 'postLogin'> & {
...
export async function dispatchOperatorRoutes(
  req: Request,
  handlers: OperatorRouteHandlers,
