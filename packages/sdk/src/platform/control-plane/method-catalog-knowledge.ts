...
import {
  ...
  KNOWLEDGE_CONNECTOR_INGEST_INPUT_SCHEMA,
  ...
  KNOWLEDGE_JOB_RUN_OUTPUT_SCHEMA,
  KNOWLEDGE_JOB_RUN_REQUEST_SCHEMA,
  ...
  KNOWLEDGE_REFINEMENT_TASK_OUTPUT_SCHEMA,
  KNOWLEDGE_REFINEMENT_TASKS_OUTPUT_SCHEMA,
  KNOWLEDGE_REPORT_OUTPUT_SCHEMA,
  KNOWLEDGE_REPORTS_OUTPUT_SCHEMA,
  KNOWLEDGE_SCHEDULE_INPUT_SCHEMA,
...
import {
  ...
  PROJECT_PLANNING_LANGUAGE_OUTPUT_SCHEMA,
  PROJECT_PLANNING_SPACE_INPUT_SCHEMA,
...
export const builtinGatewayKnowledgeMethodDescriptors: readonly GatewayMethodDescriptor[] = [
  ...
  methodDescriptor({
    ...
    inputSchema: objectSchema({ limit: NUMBER_SCHEMA, cursor: STRING_SCHEMA, ...KNOWLEDGE_SPACE_INPUT_FIELDS }),
  ...
  methodDescriptor({
    ...
    inputSchema: KNOWLEDGE_CONNECTOR_INGEST_INPUT_SCHEMA,
    outputSchema: KNOWLEDGE_BATCH_INGEST_RESULT_SCHEMA,
  }),
  methodDescriptor({
  ...
  methodDescriptor({
    ...
    inputSchema: bodyEnvelopeSchema({
      decision: KNOWLEDGE_CONSOLIDATION_DECISION_SCHEMA,
  ...
  methodDescriptor({
    ...
    category: 'knowledge',
    scopes: ['read:knowledge'],
    http: { method: 'GET', path: '/api/knowledge/refinement/tasks' },
    inputSchema: objectSchema({
      limit: NUMBER_SCHEMA,
    ...
    outputSchema: KNOWLEDGE_REFINEMENT_TASKS_OUTPUT_SCHEMA,
  }),
  methodDescriptor({
    ...
    category: 'knowledge',
    scopes: ['read:knowledge'],
    http: { method: 'GET', path: '/api/knowledge/refinement/tasks/{id}' },
    inputSchema: objectSchema({ id: STRING_SCHEMA }, ['id']),
    outputSchema: KNOWLEDGE_REFINEMENT_TASK_OUTPUT_SCHEMA,
  }),
  methodDescriptor({
    ...
    access: 'admin',
    scopes: ['write:knowledge'],
    http: { method: 'POST', path: '/api/knowledge/refinement/run' },
    inputSchema: bodyEnvelopeSchema({
      knowledgeSpaceId: STRING_SCHEMA,
      spaceId: STRING_SCHEMA,
  ...
  methodDescriptor({
    ...
    access: 'admin',
    scopes: ['write:knowledge'],
    http: { method: 'POST', path: '/api/knowledge/refinement/tasks/{id}/cancel' },
    inputSchema: bodyEnvelopeSchema({ id: STRING_SCHEMA }, ['id']),
    outputSchema: KNOWLEDGE_REFINEMENT_TASK_OUTPUT_SCHEMA,
  }),
  methodDescriptor({
  ...
  methodDescriptor({
    ...
    inputSchema: bodyEnvelopeSchema({
      ...
      schedule: KNOWLEDGE_SCHEDULE_INPUT_SCHEMA,
      metadata: METADATA_SCHEMA,
    }, ['jobId', 'schedule']),
    outputSchema: KNOWLEDGE_SCHEDULE_OUTPUT_SCHEMA,
  }),
  ...
  methodDescriptor({
    ...
    events: [runtimeEventId('knowledge')],
    inputSchema: KNOWLEDGE_JOB_RUN_REQUEST_SCHEMA,
    outputSchema: KNOWLEDGE_JOB_RUN_OUTPUT_SCHEMA,
  }),
  methodDescriptor({
    id: 'knowledge.lint',
  ...
  methodDescriptor({
    ...
    outputSchema: KNOWLEDGE_MAP_OUTPUT_SCHEMA,
  }),
  methodDescriptor({
  ...
  methodDescriptor({
    ...
    inputSchema: bodyEnvelopeSchema({
      ...
      variables: GRAPHQL_VARIABLES_SCHEMA,
    }, ['query']),
  ...
  methodDescriptor({
    ...
    category: 'knowledge',
    scopes: ['read:knowledge'],
    http: { method: 'GET', path: '/api/projects/planning/status' },
    inputSchema: PROJECT_PLANNING_SPACE_INPUT_SCHEMA,
    outputSchema: PROJECT_PLANNING_STATUS_SCHEMA,
  }),
  methodDescriptor({
    ...
    category: 'knowledge',
    scopes: ['read:knowledge'],
    http: { method: 'GET', path: '/api/projects/planning/state' },
    inputSchema: objectSchema({ projectId: STRING_SCHEMA, knowledgeSpaceId: STRING_SCHEMA, planningId: STRING_SCHEMA }),
    outputSchema: PROJECT_PLANNING_STATE_OUTPUT_SCHEMA,
  }),
  methodDescriptor({
    ...
    access: 'admin',
    scopes: ['write:knowledge'],
    http: { method: 'POST', path: '/api/projects/planning/state' },
    inputSchema: bodyEnvelopeSchema({
      projectId: STRING_SCHEMA,
      knowledgeSpaceId: STRING_SCHEMA,
      state: JSON_RECORD_SCHEMA,
    }, ['state']),
    outputSchema: PROJECT_PLANNING_STATE_OUTPUT_SCHEMA,
  }),
  methodDescriptor({
    ...
    category: 'knowledge',
    scopes: ['read:knowledge'],
    http: { method: 'POST', path: '/api/projects/planning/evaluate' },
    inputSchema: bodyEnvelopeSchema({
      projectId: STRING_SCHEMA,
      knowledgeSpaceId: STRING_SCHEMA,
      planningId: STRING_SCHEMA,
      state: JSON_RECORD_SCHEMA,
    }),
    outputSchema: PROJECT_PLANNING_EVALUATION_SCHEMA,
  }),
  methodDescriptor({
    ...
    category: 'knowledge',
    scopes: ['read:knowledge'],
    http: { method: 'GET', path: '/api/projects/planning/decisions' },
    inputSchema: PROJECT_PLANNING_SPACE_INPUT_SCHEMA,
    outputSchema: PROJECT_PLANNING_DECISIONS_OUTPUT_SCHEMA,
  }),
  methodDescriptor({
    ...
    access: 'admin',
    scopes: ['write:knowledge'],
    http: { method: 'POST', path: '/api/projects/planning/decisions' },
    inputSchema: bodyEnvelopeSchema({
      projectId: STRING_SCHEMA,
      knowledgeSpaceId: STRING_SCHEMA,
  ...
  methodDescriptor({
    ...
    category: 'knowledge',
    scopes: ['read:knowledge'],
    http: { method: 'GET', path: '/api/projects/planning/language' },
    inputSchema: PROJECT_PLANNING_SPACE_INPUT_SCHEMA,
  ...
  methodDescriptor({
    ...
    access: 'admin',
    scopes: ['write:knowledge'],
    http: { method: 'POST', path: '/api/projects/planning/language' },
    inputSchema: bodyEnvelopeSchema({
      projectId: STRING_SCHEMA,
      knowledgeSpaceId: STRING_SCHEMA,
      language: JSON_RECORD_SCHEMA,
    }, ['language']),
    outputSchema: PROJECT_PLANNING_LANGUAGE_OUTPUT_SCHEMA,
  }),
  methodDescriptor({
