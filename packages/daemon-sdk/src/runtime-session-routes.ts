...
export type SharedSessionRecordResponse = {
  readonly id: string;
  readonly kind: 'tui' | 'agent' | 'webui' | 'companion-task' | 'companion-chat' | 'automation' | 'acp' | 'hosted';
...
export const SHARED_SESSION_KINDS = new Set<SharedSessionRecordResponse['kind']>(['tui', 'agent', 'webui', 'companion-task', 'companion-chat', 'automation', 'acp', 'hosted']);
