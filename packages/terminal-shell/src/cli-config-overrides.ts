...
import type { ConfigKey, ConfigManager, ConfigSetting, GoodVibesConfig } from '@pellux/goodvibes-sdk/platform/config';
import { CONFIG_SCHEMA } from '@pellux/goodvibes-sdk/platform/config';
import { ConfigError } from '@pellux/goodvibes-sdk/platform/types';
