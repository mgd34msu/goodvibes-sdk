 ...
 * else, so this module turns those two facts into lines that a front-end's
 * own startup-reachability wiring prints ahead of the session.
 *
 * Pure by construction: it is handed a completed scan and two version strings
 * and decides only what to say.
 */

import { compareVersions, normalizeVersion } from '@pellux/goodvibes-sdk/platform/runtime/self-update';
