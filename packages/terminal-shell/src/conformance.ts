/**
 * conformance.ts — the descriptor/handler drift gate, shipped with the package
 * so every consuming front-end can run it against its own composition in CI.
 *
 ...
 * pass its concrete GatewayMethodCatalog (or any equivalent) without this
 * package depending on the catalog's full type.
 */
