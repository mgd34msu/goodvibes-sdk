...
//
// Consequences per editing context:
...
//     'delete'    → no-op              ✓
//
//   A long-form draft buffer (end-anchored, no cursor)
//     'backspace' → remove last char   ✓
//     'delete'    → open a confirmation gate (y/Enter confirms clear;
//                   n/Esc cancels). The draft is NOT wiped until the user
//                   confirms.
//
