 ...
 * These helpers answer the recurring questions a `--enable`/`--disable` flag
 * (see cli-config-overrides.ts) needs:
...
/** The CONFIG_SCHEMA descriptor for a settings key, or null for front-end-local synthetics. */
