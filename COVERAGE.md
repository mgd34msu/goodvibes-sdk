...
| T125 | `test/platform-bookmarks-smoke.test.ts` |
| T126 | `test/platform-discovery-smoke.test.ts` |
| T127 | `test/platform-eval-smoke.test.ts` |
| T128 | `test/platform-export-smoke.test.ts` |
| T129 | `test/platform-forensics-smoke.test.ts` |
| T130 | `test/platform-git-smoke.test.ts` |
| T131 | `test/platform-http-context-inheritance.test.ts` |
| T132 | `test/platform-multimodal-smoke.test.ts` |
| T133 | `test/platform-network-smoke.test.ts` |
| T134 | `test/platform-orchestration-smoke.test.ts` |
| T135 | `test/platform-plugins-smoke.test.ts` |
| T136 | `test/platform-profiles-smoke.test.ts` |
| T137 | `test/platform-route-manager-emissions.test.ts` |
| T138 | `test/platform-state-inspector-smoke.test.ts` |
| T139 | `test/platform-stop-reason-mappers.test.ts` |
| T140 | `test/platform-store-domains-smoke.test.ts` |
| T141 | `test/platform-templates-smoke.test.ts` |
| T142 | `test/platform-trigger-executor-shell-split.test.ts` |
| T143 | `test/platform-workflow-smoke.test.ts` |
| T144 | `test/process-manager-timeout.test.ts` |
| T145 | `test/project-planning-routes.test.ts` |
| T146 | `test/project-planning-service.test.ts` |
| T147 | `test/provider-registry-canonical-api.test.ts` |
| T148 | `test/provider-routes-secrets-skipped.test.ts` |
| T149 | `test/provider-routes.test.ts` |
| T150 | `test/provider-sse-integration.test.ts` |
| T151 | `test/rn-bundle-node-imports.test.ts` |
| T152 | `test/router-e2e-automation.test.ts` |
| T153 | `test/router-e2e-control.test.ts` |
| T154 | `test/router-e2e-remote.test.ts` |
| T155 | `test/router-e2e-session.test.ts` |
| T156 | `test/router-e2e-tasks.test.ts` |
| T157 | `test/router-e2e-telemetry.test.ts` |
| T158 | `test/runtime-event-discriminated-union.test.ts` |
| T159 | `test/runtime-session-input-cancel.test.ts` |
| T160 | `test/scan-modes.test.ts` |
| T161 | `test/scheduler-capacity.test.ts` |
| T162 | `test/sdk-auth.test.ts` |
| T163 | `test/sdk-observer.test.ts` |
| T164 | `test/sdk-platforms.test.ts` |
| T165 | `test/sdk-runtime-boundaries.test.ts` |
| T166 | `test/sdk-transport-http.test.ts` |
| T167 | `test/sec-01-user-auth-perms.test.ts` |
| T168 | `test/sec-02-safecopy-perms.test.ts` |
| T169 | `test/sec-03-login-ratelimit.test.ts` |
| T170 | `test/sec-04-input-sanitization.test.ts` |
| T171 | `test/sec-05-body-size-cap.test.ts` |
| T172 | `test/sec-06-rate-limiter-lru.test.ts` |
| T173 | `test/sec-07-origin-defaults.test.ts` |
| T174 | `test/sec-08-ssrf-filter.test.ts` |
| T175 | `test/sec-09-permission-normalization.test.ts` |
| T176 | `test/sec-10-sandbox-boundary.test.ts` |
| T177 | `test/secret-refs.test.ts` |
| T178 | `test/session-broker.test.ts` |
| T179 | `test/session-cookie-auth-roundtrip.test.ts` |
| T180 | `test/slack-surface-credentials.test.ts` |
| T181 | `test/smoke.test.ts` |
| T182 | `test/sqlite-vec-resolver.test.ts` |
| T183 | `test/state-tool-workspace-keys.test.ts` |
| T184 | `test/traceparent-propagation.test.ts` |
| T185 | `test/transport-direct.test.ts` |
| T186 | `test/transport-http.test.ts` |
| T187 | `test/transport-middleware.test.ts` |
| T188 | `test/transport-realtime.test.ts` |
| T189 | `test/version-consistency.test.ts` |
| T190 | `test/version-sync.test.ts` |
| T191 | `test/voice-stt-realtime-smoke.test.ts` |
| T192 | `test/voice-tts-stream.test.ts` |
| T193 | `test/web-search-providers-smoke.test.ts` |
| T194 | `test/workspace-swap-http.test.ts` |
| T195 | `test/workspace-swap-reroot.test.ts` |
| T196 | `test/wrfc-constraint-propagation.test.ts` |
| T197 | `test/wrfc-controller.test.ts` |
| T198 | `test/wrfc-prompt-addenda.test.ts` |
| T199 | `test/zod-validation.test.ts` |
...
| # | File |
|---|------|
| I001 | `test/integration/_shared/arbitraries.unit.test.ts` |
| I002 | `test/integration/any-runtime-event-property.test.ts` |
| I003 | `test/integration/auth-flow-e2e.test.ts` |
