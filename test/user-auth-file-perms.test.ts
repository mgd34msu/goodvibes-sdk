/**
 * auth-user store (scrypt password hashes) must be written with mode 0600.
 *
 * Covers:
 *   - writeBootstrapUsers (via persisted user-store writes)
...
describe('auth-user store file permissions', () => {
  let dir: string;
