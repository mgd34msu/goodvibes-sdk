...
/**
 * OBS-21: Error normalize/summarize redaction smoke — verifies that the
 ...
 *
 * NOTE (MAJ-07): This file does NOT test pairing.request / pairing.verify flows.
 * COVERAGE.md has been updated to reflect the actual scope.
 */
describe('obs-21 normalize/summarize redaction smoke', () => {
