/**
 *
 * Listener error counter + OPS_LISTENER_MISBEHAVING dedup emission.
 * Verifies:
...
describe('listener_errors_total counter', () => {
...
describe('OPS_LISTENER_MISBEHAVING OpsEvent emission', () => {
