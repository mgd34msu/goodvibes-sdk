...
import { createWireSessionDispatch } from '../packages/sdk/src/platform/runtime/client/session-dispatch.ts';
import type { SessionInputsWireClient } from '../packages/sdk/src/platform/runtime/client/session-dispatch.ts';
