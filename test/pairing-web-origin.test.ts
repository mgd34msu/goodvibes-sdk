...
import { resolvePairingWebOrigin, ensurePublicBaseUrl, isHttpOnLan } from '../packages/sdk/src/platform/pairing/web-origin.ts';
import type { StableHostInputs } from '../packages/sdk/src/platform/pairing/stable-host.ts';
import type { ConfigKey, ConfigManager } from '../packages/sdk/src/platform/config/index.ts';
