...
import { formatLastSeen, formatCreated, formatDeviceLine, resolveTokenByIdPrefix, shortTokenId } from '../packages/sdk/src/platform/pairing/device-lines.ts';
import type { PublicPairingToken } from '../packages/sdk/src/platform/pairing/index.ts';
