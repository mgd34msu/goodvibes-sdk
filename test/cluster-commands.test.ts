...
//
//   1. the command layer holds NO cluster logic. Every subcommand is a parse,
//      one call to a daemon verb, and a rendering. If that ever stops being
//      true, a front-end's own `/cluster` command and this one can disagree,
//      and one of them is then lying.
//
...
import { clipboardEscapeSequence, describeAge, renderStatus } from '@pellux/goodvibes-terminal-shell';
