...
describe('GET /api/companion/chat/sessions/:id/messages', () => {
...
describe('method catalog registers companion-chat methods', () => {
  ...
  test('companion.chat.messages.list descriptor targets GET /messages', () => {
    const catalog = new GatewayMethodCatalog({ includeBuiltins: true });
