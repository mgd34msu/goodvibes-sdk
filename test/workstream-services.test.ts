...
import { AdaptivePlanner } from '../packages/sdk/src/platform/core/index.ts';
import type { PhaseRunnerAgentManagerLike } from '../packages/sdk/src/platform/orchestration/index.ts';
import type { AgentRecord } from '../packages/sdk/src/platform/tools/index.ts';
import { RuntimeEventBus, createEventEnvelope } from '../packages/sdk/src/platform/runtime/events/index.ts';
import type { ConfigManager } from '../packages/sdk/src/platform/config/index.ts';
import { configGetStub, configGetCategoryStub } from './_helpers/config-manager-stub.ts';
import { createWorkstreamServices } from '../packages/sdk/src/platform/orchestration/workstream-services.ts';
