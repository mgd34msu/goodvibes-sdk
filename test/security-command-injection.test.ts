...
import { classifySegment, classifyCommand, higherPriority } from './_helpers/runtime-seam.ts';
import { canonicalize } from './_helpers/runtime-seam.ts';
import type { CommandSegment } from './_helpers/runtime-seam.ts';
